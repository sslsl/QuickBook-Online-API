    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>211/230</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>198/213</span>
            </div>
...
<a name='L633'></a><a href='#L633'>633</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    .then((res) =&gt; {
      const authResponse = res.json ? res : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
      const json = (authResponse &amp;&amp; authResponse.getJson()) || <span class="branch-2 cbranch-no" title="branch not covered" >res;</span>
...
<span class="cstat-no" title="statement not covered" >      this.log('error', 'Revoke Token () threw an exception : ', JSON.stringify(e, null, 2));</span>
...
&nbsp;
    ...
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      this.log('error', 'Get User Info ()  threw an exception : ', JSON.stringify(e, null, 2));</span>
<span class="cstat-no" title="statement not covered" >      throw e;</span>
    });
};
&nbsp;
...
&nbsp;
    params.body &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >request.body = params.body)</span>;
&nbsp;
    resolve(this.getTokenRequest(request));
  })
    .then((authResponse) =&gt; {
    ...
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      this.log('error', 'Get makeAPICall ()  threw an exception : ', JSON.stringify(e, null, 2));</span>
<span class="cstat-no" title="statement not covered" >      throw e;</span>
    });
};
&nbsp;
...
&nbsp;
    const id_token = this.getToken().id_token || <span class="branch-1 cbranch-no" title="branch not covered" >params.id_token;</span>
&nbsp;
    // Decode ID Token
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (id_token_payload.iss !== 'https://oauth.platform.intuit.com/op/v1') <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
    // Step 2 : check if the aud field in idToken contains application's clientId
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!id_token_payload.aud.find((audience) =&gt; audience === this.clientId)) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
    // Step 3 : ensure the timestamp has not elapsed
    <span class="missing-if-branch" title="if path not taken" >I</span>if (id_token_payload.exp &lt; Date.now() / 1000) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
    const request = {
...
&nbsp;
    ...
    .then((res) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (res) return true;
...
OAuthClient.prototype.getKeyFromJWKsURI = function getKeyFromJWKsURI(id_token, kid, request) {
  return new Promise((resolve) =&gt; {
    ...
    .then((response) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Number(response.status) !== 200) <span class="cstat-no" title="statement not covered" >throw new Error('Could not reach JWK endpoint');</span>
      // Find the key by KID
...
&nbsp;
    ...
    .catch((e) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!e.authResponse) e = this.createError(e, authResponse);
      throw e;
    });
};
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed May 13 2020 13:56:29 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
