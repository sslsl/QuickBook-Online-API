...
function getCallGraphMvn(targetPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const classPath = yield metrics_1.timeIt('getMvnClassPath', () => mvn_wrapper_1.getClassPathFromMvn(targetPath));
        return yield metrics_1.timeIt('getCallGraph', () => java_wrapper_1.getCallGraph(classPath, targetPath));
    });
}
exports.getCallGraphMvn = getCallGraphMvn;
function getClassGraphGradle(targetPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
