...
function analyze(targetImage, dockerfileAnalysis, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { imageId, manifestLayers, extractedLayers, } = yield archiveExtractor.getArchiveLayersAndManifest(options.imageType, options.imagePath, staticAnalysisActions);
        ...
        let osRelease;
        try {
            osRelease = yield osReleaseDetector.detectStatically(extractedLayers, dockerfileAnalysis);
        }
        catch (err) {
            debug(err);
        ...
        const nodeDependenciesScanResults = yield applications_1.nodeFilesToScannedProjects(static_5.getNodeAppFileContent(extractedLayers));
