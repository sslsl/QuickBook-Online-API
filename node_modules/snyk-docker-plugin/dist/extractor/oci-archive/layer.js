 ...
 */
function extractArchive(ociArchiveFilesystemPath, extractActions) {
            ...
            tarExtractor.on("entry", (header, stream, next) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                if (header.type === "file") {
                    if (isImageIndexFile(header.name)) {
                        imageIndex = yield stream_utils_1.streamToJson(stream);
                    }
                    else {
                        ...
                        const [manifest, layer] = yield Promise.all(promises);
