 ...
 */
function getArchiveLayersAndManifest(imageType, fileSystemPath, extractActions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        switch (imageType) {
            case types_1.ImageType.OciArchive:
                const ociArchive = yield ociExtractor.extractArchive(fileSystemPath, extractActions);
                return {
            ...
            default:
                const dockerArchive = yield dockerExtractor.extractArchive(fileSystemPath, extractActions);
                return {
...
exports.getArchiveLayersAndManifest = getArchiveLayersAndManifest;
